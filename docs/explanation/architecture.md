...
This pattern is called Functional Core / Imperative Shell. The "shell" is a thin CGI entry point (`files/www/cgi-bin/luci-sso`) that wires real I/O into the core and calls it. The "core" is everything in `src/`.
