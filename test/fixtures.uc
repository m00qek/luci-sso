 ...
 */
export let RS256_PUBKEY = "-----BEGIN PUBLIC KEY-----\n" +
...
export let RS256_MSG = "hello world";
 ...
 */
export let RS256_SIG_B64URL = "A4WLYP1G7SK3zpg7Ni_le_B0LzUUu1uLbFu1HXAApX3hkUiQLl1c7PWqMe408RqK-MqBiTB3mqJ9fXY1Z937kamwY5ycD1gMhyhfa9CgqrLA6jTZojcCanKqu13GWhZCNB5QiGu8O_sY-CUew-F32yef6rrx896BkfiB7Tyovg_jhsXEPyGX_Yf3CCPfGcMcRf-2pFIX1pnulUPgxVVIbidAuJ1SHxNI7UA3xTJq9phR5B_pnbNay1aVp50ewnKQoGFJj9EabFBVMkeRUCON29ZSt9YgDd1-0swWrZWEI3g3J25fbuVQS5IrxvLOZcjRE5zuc9m8RB4zY4PrbLQwQA";

/**
 * RS256 JWT
 * Generated with:
 *   HEADER=$(echo -n '{"alg":"RS256","typ":"JWT"}' | openssl base64 -A | tr '+/' '-_' | tr -d '=')
 *   PAYLOAD=$(echo -n '{"sub":"1234567890","name":"John Doe","iat":1516239022}' | openssl base64 -A | tr '+/' '-_' | tr -d '=')
 *   DATA="$HEADER.$PAYLOAD"
 *   echo -n "$DATA" | openssl dgst -sha256 -sign key.pem | openssl base64 -A | tr '+/' '-_' | tr -d '=' 
 */
export let RS256_JWT_PUBKEY = "-----BEGIN PUBLIC KEY-----\n" +
...
export let COVERAGE_PUBKEY = "-----BEGIN PUBLIC KEY-----\n" +
...
/**
 * Generated with:
 *   openssl ecparam -name prime256v1 -genkey -noout -out es256.pem
 *   openssl ec -in es256.pem -pubout -out es256_pub.pem
 */
export let ES256_PUBKEY = "-----BEGIN PUBLIC KEY-----\n" +
...
export let ES256_MSG = "hello world";

/**
 * Generated via DER -> Raw conversion.
 */
export let ES256_SIG_HELLO_B64URL = "kknuSsOSyfDerTgtfm3suX9uNMviVkI899Y-duZPgx8KqzhWVTk_qpJBN6Bb2GvdYgfBFGjcEKOmtE1swUiS-Q";

export let ES256_JWT_TOKEN = "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJlczI1NiIsIm5hbWUiOiJFUzI1NiBVc2VyIn0.62l8TeaDDc0cYo1d_w8agIskddI3aethFM_wz6pU_4kcg3QVrFLiNm5zbc9CxmzE25eaOidqEgWwBlbeRcJlDw";