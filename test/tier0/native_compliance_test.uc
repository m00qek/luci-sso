...
describe('native: compliance', () => {
	it('SHA256 standard message', () => {
	...
	it('HMAC-SHA256 standard message', () => {
	...
	it('SHA256 with embedded null bytes', () => {
	...
	it('HMAC-SHA256 with embedded null bytes', () => {
	...
	it('HMAC-SHA256 with leading zeros', () => {
	...
	it('HMAC-SHA256 with oversized key (RFC 2104)', () => {
	...
	it('RSA verification with embedded null bytes', () => {
	...
	it('ES256 verification with embedded null bytes', () => {
	...
	it('ES256 low-bit verification (leading zeros)', () => {
	...
	it('negative verification (wrong message)', () => {
		let sig = hex_to_bin(f.RSA_2048.sig_hex);
	...
	it('negative verification (wrong key)', () => {
		let sig = hex_to_bin(f.RSA_2048.sig_hex);
	...
	it('RSA reject small public exponents (e < 65537)', () => {
