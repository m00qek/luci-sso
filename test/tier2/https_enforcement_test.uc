...
describe('oidc: discovery', () => {
	it('reject insecure HTTP issuer', () => {
		let res = oidc.discover({ native }, "http://insecure.com");
	...
	it('reject insecure internal issuer URL', () => {
		let res = oidc.discover({ native }, "https://secure.com", { internal_issuer_url: "http://insecure.local" });
