...
describe('discovery: security', () => {
	it('prevent cache poisoning on issuer mismatch (B5)', () => {
	...
	it('prevent cache poisoning on missing required fields', () => {
		let issuer = "https://trusted.idp";
	...
	it('ensure sanitized logging on issuer mismatch (W4)', () => {
		let issuer = "https://trusted.idp";
	...
	it('normalized issuer comparison (W2)', () => {
		let issuer = "https://trusted.idp/";
