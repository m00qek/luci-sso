...
describe('web: rendering', () => {
	it('standardized error prevents internal leakage', () => {
...
describe('web: security', () => {
	it('prevent XSS in redirect location', () => {
	...
	it('safe_getenv returns Result.err on overflow', () => {
		let long_val = "";
	...
	it('emission of hardened security headers', () => {
		let deps = make_web_deps({});
