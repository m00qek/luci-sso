...
describe('crypto: plumbing', () => {
	...
	it('clock tolerance boundary math', () => {
	...
	it('invalid algorithm in header', () => {
		let key = "key";
	...
	it('JWK to secret (OCT/symmetric)', () => {
	...
	it('correlation ID stability (safe_id)', () => {
...
describe('crypto: torture', () => {
	it('illegal type injection', () => {
	...
	it('JSON depth (complexity limit)', () => {
		let deep = "{\"a\":";
	...
	it('buffer transition stability', () => {
