...
run_unit() {
  ...
  if [ -n "$modules" ]; then
    ...
    bundles="/usr/share/luci-sso/test/tier0 /usr/share/luci-sso/test/tier1 /usr/share/luci-sso/test/tier2 /usr/share/luci-sso/test/tier3 /usr/share/luci-sso/test/tier4 /usr/share/luci-sso/test/unit/luci_sso /usr/share/luci-sso/test/unit/luci_sso/crypto /usr/share/luci-sso/test/unit/luci_sso/session"
  fi
